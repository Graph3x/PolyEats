...
import geocoding_pb2 as geocoding__pb2
...
def add_GeocodingServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'geocoding.Geocoding', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('geocoding.Geocoding', rpc_method_handlers)
